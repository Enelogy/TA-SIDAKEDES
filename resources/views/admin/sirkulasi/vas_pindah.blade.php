        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Data Pindahan Penduduk</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Data Pindahan Penduduk</h4>
                            <button type="button" id="add" name="add"
                                class="btn btn-success btn-sm mb-2 add">Tambah</button>

                            <input type="hidden" value="3" id="id_jenis" name="id_jenis">
                        ...
                        <div class="form">
                            <div class="form-group">
                                ...
                                <label class="" data-error="wrong" data-success="right" for="id_penduduk">Nama
                                    Penduduk</label>
                                <select class="form-control mb-1" name="id_penduduk" id="id_penduduk">
                                ...
                                <label class="" data-error="wrong" data-success="right" for="tgl_pindah">Tanggal
                                    Pindah</label>
                                <input type="date" name="tgl_pindah" id="tgl_pindah" class="form-control mb-1">

                                <label class="" data-error="wrong" data-success="right" for="alasan_sp">Alasan</label>
                                <input type="text" name="alasan_sp" id="alasan_sp" class="form-control">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            tabel = $("#tabelbasic").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/sirkulasi/pindah-s') }}",
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        $('#submit').on('click', function(id) {
            ...
            $.ajax({
                url: "{{ url('admin/sirkulasi/pindah-s/tambah') }}",
                type: "POST",
