        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Data Kematian Penduduk</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Data Kematian Penduduk</h4>
                    ...
                    <div class="modal-body mx-3">
                        <div class="form">
                            <div class="form-group">
                                ...
                                <label class="" data-error="wrong" data-success="right" for="tgl_sk">Tanggal
                                    Meninggal</label>
                                <input type="date" name="tgl_sk" id="tgl_sk" class="form-control mb-1">

                                <label class="" data-error="wrong" data-success="right" for="sebab_sk">Sebab</label>
                                <input type="text" name="sebab_sk" id="sebab_sk" class="form-control">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            tabel = $("#tabelbasic").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/sirkulasi/kematian-s') }}",
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        $('#submit').on('click', function(id) {
            ...
            $.ajax({
                url: "{{ url('admin/sirkulasi/kematian-s/tambah') }}",
                type: "POST",
