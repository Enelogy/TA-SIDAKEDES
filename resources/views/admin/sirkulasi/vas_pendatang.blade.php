        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Data Penduduk Pendatang</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Data Penduduk Pendatang</h4>
                    ...
                    <div class="modal-body mx-3">
                        <div class="form">
                            <div class="form-group">
                                ...
                                <label class="" data-error="wrong" data-success="right" for="tgl_datang">Tanggal
                                </label>
                                <input type="date" name="tgl_datang" id="tgl_datang" class="form-control mb-1">

                                <label class="" data-error="wrong" data-success="right" for="pelapor">Pelapor</label>
                                <input type="text" name="pelapor" id="pelapor" class="form-control">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            tabel = $("#tabelbasic").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/sirkulasi/pendatang-s') }}",
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        $('#submit').on('click', function(id) {
            ...
            $.ajax({
                url: "{{ url('admin/sirkulasi/pendatang-s/tambah') }}",
                type: "POST",
