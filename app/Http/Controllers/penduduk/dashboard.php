...
class dashboard extends Controller
{
    ...
    public function index()
    {
        ...
        $penduduk = penduduk::where(function ($query) {
            $query->where('status_p', '=', 0)->orWhere('status_p', '=', 2)->orWhere('status_p', '=', 4);
        })->get();
        // $kks = kartu_keluarga_s::all();
        $kks = kk::all();
        // $laki = penduduk::where('jenis_kelamin', 'laki-laki')->get();
        ...
        $nkks = count($kks);
        // dd($nkks);
        return view('penduduk.vp_dashboard', compact('nkks', 'npenduduk', 'nlaki', 'nperempuan', 'nlahir', 'nkematian', 'npendatang', 'npindah'));
    }
